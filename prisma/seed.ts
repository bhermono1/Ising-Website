  ...
  const rooms = [
    {
      name: "Small Room 1",
      slug: "small-room-1",
      description: "A cozy private room perfect for small groups of 2–6. Great for intimate sessions with friends or a date night.",
      capacity: 6,
      weekdayRatePerPerson: 7.50,
      weekendRatePerPerson: 9.50,
      amenities: ["Premium sound system", "Tablet song catalog", "Mood lighting"],
      seed: "small-room-1",
    },
    {
      name: "Small Room 2",
    ...
    },
    {
      name: "Medium Room 1",
      slug: "medium-room-1",
      description: "A spacious room ideal for groups of 7–12. Perfect for birthday parties, get-togethers, and celebrations.",
      capacity: 12,
      weekdayRatePerPerson: 7.50,
      weekendRatePerPerson: 9.50,
      amenities: ["Premium sound system", "Disco lighting", "Tablet song catalog", "Lounge seating"],
      seed: "medium-room-1",
    },
    {
      name: "Medium Room 2",
    ...
    },
    {
      name: "Large Room",
      slug: "large-room",
      description: "A large private room for groups of 13–18. Bring the whole crew for an unforgettable night out.",
      capacity: 18,
      weekdayRatePerPerson: 7.50,
      weekendRatePerPerson: 9.50,
      amenities: ["Premium sound system", "Disco lighting", "Tablet song catalog", "Dance floor", "Lounge seating"],
      seed: "large-room",
    },
    {
      name: "X-Large Room",
      slug: "x-large-room",
      description: "Our biggest room for groups of 19–24. Perfect for large events, company parties, and big celebrations.",
      capacity: 24,
      weekdayRatePerPerson: 7.50,
      weekendRatePerPerson: 9.50,
      amenities: ["Premium sound system", "Disco lighting", "Tablet song catalog", "Dance floor", "Lounge seating", "Photo booth corner"],
      seed: "x-large-room",
    },
  ];
  ...
  for (const [index, room] of rooms.entries()) {
    await prisma.room.upsert({
      ...
      update: {
        ...
        weekdayRatePerPerson: room.weekdayRatePerPerson,
        weekendRatePerPerson: room.weekendRatePerPerson,
